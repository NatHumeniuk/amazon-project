...
import { cart } from "./orderSummary.js";
...
export function renderPaymentSummary() {
  ...
  const taxCentc = totalBeforeTaxCents * 0.1;
  const totalCents = totalBeforeTaxCents + taxCentc;

  const paymentSummaryHTML = `
    <div class="payment-title">Order Summary</div>

    <div class="payment-summary-row">
      <div >Items (${updateItemQuantity()}):</div>
    ...
    <div class="payment-summary-row">
      ...
      <div class="payment-summary-money">$${formatCurrency(taxCentc)}</div>
    </div>
